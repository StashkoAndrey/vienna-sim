...
metric_cols = [
    ...
    #"survival_time", "zero_crossings", "dwell_time_entropy","avg_bacteria","spectral_entropy",
]
...
def plot_big_grid():
    ...
    plt.tight_layout()
    fig.savefig("plots/all_metric_projections_grid.png")
    print("Combined grid saved as plots/all_metric_projections_grid.png")
